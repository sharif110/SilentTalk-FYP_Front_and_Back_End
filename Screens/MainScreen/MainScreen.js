  ...
  const handleUpload = () => {
    ...
    launchImageLibrary(options, (response) => {
      ...
      if (response.didCancel) {
        ...
        // You can handle the selected video here, for example, upload it
        console.log('Selected video:', response.uri);
        // Implement upload logic here, for example, using fetch or a library like Axios
      }
    });
  };
